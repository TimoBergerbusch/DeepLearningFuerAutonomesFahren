...
\end{subfigure}
\caption{An example of a Softmax loss network. Blue boxes are the different layers and the yellow boxes are the blobs. Note that in (a) the parameters are not mentioned since they don't add value to this example. There are things defined like kernel size, image scaling or image origin.}
