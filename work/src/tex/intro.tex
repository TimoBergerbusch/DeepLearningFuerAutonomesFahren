...
\subsection{Predefined Layers and Functions}
Creating different CNN often use a similar set of layers. For that purpose there are some layers already defined by \cnnarch to simplify the usage.
