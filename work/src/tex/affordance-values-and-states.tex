...
%			\path[fill=green!50!black] (O) circle (3.95cm);
	...
	\caption{Visualization of the affordance indicators listed in \Cref{lst: affordance indicators}. The red block is the agent, the orange blocks are other cars and the white arrows indicate the velocity. Gray cars are neglected, because of the currently active system.}
