\begin{figure}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		...
		\draw[<->, white, ultra thick] (2.5,0.95) -- (1.9,0.95);
		\draw[<->, white, ultra thick] (2.5,0.95) -- (3.1,0.95);
		
		\draw[<->, white, ultra thick] (2.5,0.65) -- (0.6,0.65);
		\draw[<->, white, ultra thick] (2.5,0.65) -- (4.4,0.65);
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		...
		\draw[<->, white, ultra thick] (1.2,0.95) -- (1.2,3.9);
		\draw[<->, white, ultra thick] (2.5,0.95) -- (2.5,2.6);
		\draw[<->, white, ultra thick] (3.8,0.95) -- (3.8,3.2);
		\end{tikzpicture}
...
%			\path[fill=green!50!black] (O) circle (3.95cm);
			...
			\draw[->, white, ultra thick] (2,2.3) -- (1,3.45);
	...
	\begin{subfigure}[b]{0.32\textwidth}
		...
		\draw[-, white] (2.1,1.2) -- (2.1,0.4);
		
		\draw[<->, white, thin] (2.1,0.95) -- (1.8,0.95);
		
		\draw[<->, white, ultra thick] (2.1,0.65) -- (0.6,0.65);
		\draw[<->, white, ultra thick] (2.1,0.65) -- (3.1,0.65);
		\end{tikzpicture}
		\caption{free lane}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		...
		\draw[<->, white, ultra thick] (2.15,1) -- (2.8,1);
		
		\draw[<->, white, ultra thick] (1.4,2) -- (2.3,2);
		\end{tikzpicture}
		\caption{equal fast car in same lane}
		\label{fig: affordance indicators: overlapping areas}
	\end{subfigure}
	
	\caption{The 3 scenarios causing problems with behavior reflex approaches. The red block is the agent, the orange block the other car, the white arrows indicate the velocity and the green arrows the logically deduced behaviors. The names of the indicators is given in \Cref{lst: affordance indicators}}
