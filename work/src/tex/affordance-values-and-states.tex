...
%			\path[fill=green!50!black] (O) circle (3.95cm);
	...
	\caption{The 3 scenarios causing problems with behavior reflex approaches. The red block is the agent, the orange block the other car, the white arrows indicate the velocity and the green arrows the logically deduced behaviors. The names of the indicators is given in \Cref{lst: affordance indicators}. In addition i) (ii)) denotes the active range of the ``on marking system'' (``in lane system'').}
